    ...
    return (
        <View style={{ flex: 1, alignItems:'center' }}>
            ...
            <View style={{
                ...
                <View style={[styles.box1, {position:'absolute', right:SIZES.padding * 2, top:SIZES.padding * 2, opacity:0.3, backgroundColor:'grey',}]} />
                <View style={[styles.box2, {position:'absolute', right:SIZES.padding * 2, bottom:SIZES.padding * 2, opacity:0.3, backgroundColor:'grey',}]} />
                ...
                >   
                        <Text>Didn`t have an Account yet?</Text>
                        <TouchableOpacity
                            onPress={() => navigation.navigate('Register')}
                            style={{
                                position: 'absolute',
